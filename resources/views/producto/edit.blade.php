    ...
    <form action="/productos/update/{{$prod->id}}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <x-adminlte-input name="nombre" placeholder="Razón Social del proveedor" label-class="text-lightblue" fgroup-class="col-md-12" value="{{$prod->nombre}}">
                ...
                <div class="row">
                    <x-adminlte-select2 name="termprov" label-class="text-lightblue"  fgroup-class="col-md-12"
                        ...
                        <option value="{{$rowp->id}}" @php if ($prod->terminos_pago_proveedor_id == $rowp->id) { echo "selected";} @endphp>{{$rowp->nombre}}</option>
                        @endforeach
                    </x-adminlte-select2>
                </div>
                <div class="row">
                    <x-adminlte-select name="activo">
