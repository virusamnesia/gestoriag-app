...
@section('content_header')
    <h1>Interrumpir partida del Presupuesto</h1>
@stop
...
@section('content')
    ...
    <form action="/presupuestos/lineas/interrumpir" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-1">
                <x-adminlte-button class="btn-flat" type="submit" label="Interrumpir" theme="info" icon="fas fa-lg fa-save"/>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
