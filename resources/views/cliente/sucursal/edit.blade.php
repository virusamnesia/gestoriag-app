...
@section('content')
    ...
    <form action="/clientes/sucursales/{{$cliente->id}}/{{$suc->id}}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    <x-adminlte-input name="nombre" placeholder="Razón Social de la sucursal" label-class="text-lightblue" fgroup-class="col-md-12" value="{{$suc->nombre}}">
                ...
                <div class="row">
                    <x-adminlte-input name="domicilio" placeholder="Domicilio"  fgroup-class="col-md-12" value="{{$suc->domicilio}}">
                        <x-slot name="prependSlot">
                ...
                <div class="row">
                    <x-adminlte-input name="colonia" placeholder="Colonia" fgroup-class="col-md-12" disable-feedback value="{{$suc->colonia}}"/>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <x-adminlte-input name="cp" placeholder="Código Postal"  fgroup-class="col-md-3"  maxlength="5" value="{{$suc->cp}}"
                        enable-old-support>
                        <x-slot name="prependSlot">
                ...
                <div class="row">
                    <x-adminlte-input name="email" placeholder="Correo Eléctronico" label-class="text-lightblue" fgroup-class="col-md-12" value="{{$suc->email}}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text">
                ...
                <div class="row">
                    <x-adminlte-input name="telefono" placeholder="Teléfono" label-class="text-lightblue" fgroup-class="col-md-12" value="{{$suc->telefono}}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text">
