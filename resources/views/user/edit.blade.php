            ...
            <form action="/usuarios/update/{{$usuario->id}}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <x-adminlte-input name="nombre" placeholder="Usuario" label-class="text-lightblue" fgroup-class="col-md-12" value="{{$usuario->name}}">
                        ...
                        <div class="row">
                            <x-adminlte-input name="email" placeholder="Correo Eléctronico" label-class="text-lightblue" fgroup-class="col-md-12" value="{{$usuario->email}}">
                                <x-slot name="prependSlot">
                                    <div class="input-group-text">
