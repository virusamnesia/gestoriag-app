...
@section('title', 'ProvMun')

@section('content_header')
    <h1>Municipios por proveedor</h1>
@stop

@section('content')
    <form action="/proveedores/municipios/store/{{$proveedor->id}}" method="POST">
    ...
    <div class="row">
        <div class="col-md-1">
            <x-adminlte-button label="Regresar" type="button" theme="info" icon="far fa-hand-point-left" onclick="back({{$proveedor->id}})"/>
        </div>
        <div class="col-md-10">
        </div>
        <div class="col-md-1">
