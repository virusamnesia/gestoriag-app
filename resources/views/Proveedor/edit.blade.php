...
@section('content')
    ...
    <form action="/proveedores/update/{{$prov->id}}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    <x-adminlte-input name="clave" placeholder="Clave" maxlength="12" value="{{$prov->clave}}"
                ...
                <div class="row">
                    <x-adminlte-input name="rfc" placeholder="RFC" size="15" maxlength="15" value="{{$prov->rfc}}"
