...
@section('content')
    ...
    <form action="/proveedores/update/{{$prov->id}}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    <x-adminlte-input name="clave" label="Clave" placeholder="Clave" maxlength="12" value="{{$prov->clave}}"
                        fgroup-class="col-md-3" disable-feedback/>
                </div>
                <div class="row">
                    <x-adminlte-input name="nombre" label="Razón Social" placeholder="Razón Social del proveedor" label-class="text-lightblue" fgroup-class="col-md-12" value="{{$prov->nombre}}">
                ...
                <div class="row">
                    <x-adminlte-input name="rfc" label="RFC" placeholder="RFC" size="15" maxlength="15" value="{{$prov->rfc}}"
                ...
                <div class="row">
                    <x-adminlte-select2 name="posicion" label="Posición Fiscal" label-class="text-lightblue"  fgroup-class="col-md-12"
                        ...
                        <option value="{{$rowp->id}}"@php if ($rowp->id == $prov->fiscal_position_id) { echo "selected";} @endphp>{{$rowp->nombre}}</option>
                        @endforeach
                    </x-adminlte-select2>
                </div>
                <div class="row">
                    <x-adminlte-input name="domicilio"  label="Domicilio" placeholder="Domicilio"  fgroup-class="col-md-12" value="{{$prov->domicilio}}">
                        <x-slot name="prependSlot">
                ...
                <div class="row">
                    <x-adminlte-input name="colonia" label="Colonia" placeholder="Colonia" fgroup-class="col-md-12" disable-feedback value="{{$prov->colonia}}"/>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <x-adminlte-input name="cp" label="Código Postal" placeholder="Código Postal"  fgroup-class="col-md-4"  maxlength="5" value="{{$prov->cp}}"
                        enable-old-support>
                        <x-slot name="prependSlot">
                ...
                <div class="row">
                    <x-adminlte-input name="email" label="E-mail" placeholder="Correo Eléctronico" label-class="text-lightblue" fgroup-class="col-md-12" value="{{$prov->email}}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text">
                ...
                <div class="row">
                    <x-adminlte-input name="telefono" label="Teléfono" placeholder="Teléfono" label-class="text-lightblue" fgroup-class="col-md-12" value="{{$prov->telefono}}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text">
                ...
                <div class="row">
                    <x-adminlte-input name="cuenta" label="Cuenta" placeholder="Cuenta bancaria" size="18" maxlength="18" value="{{$prov->cuenta}}"
                        fgroup-class="col-md-4" disable-feedback/>
                </div>
            </div>
            <div class="col-md-3">
