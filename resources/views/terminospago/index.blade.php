                                ...
                                <span class="pull-right">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right" aria-labelledby="dropdownmenu1">
                                            ...
                                            <li><button class="btn align-self-left" id="btndetalle" onclick="detalle({{$row->id}})"><i class="icon ion-md-create"></i>Detalles</button></li>
                                            <li><button class="btn align-self-left" id="btnview" data-toggle="modal" data-target="#smview" onclick="view({{$row->id}})"><i class="ion-md-chatboxes"></i>Ver</button></li>
