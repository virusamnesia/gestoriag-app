...
@section('content_header')
    <h1>Cerrar partida del Proyecto</h1>
@stop
...
@section('content')
    ...
    <form action="/proyectos/lineas/closeup" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <h5>Importe: {{$linea->total_v}}</h5>
                <h5>Saldo: {{$linea->saldocliente}}</h5>
                <h5>Estatus: {{$linea->estatus}}</h5>
                @csrf
                <x-adminlte-select2 name="saldo"  label="Aplicar Saldo" label-class="text-red"  fgroup-class="col-md-6"
                    igroup-size="sm" data-placeholder="Aplicar saldo..." required>
