                ...
                <div class="modal-content">
                    ...
                    <form class="form p-3" action="/termclie/nuevo" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <br>
                            <div class="row">
                                <x-adminlte-input name="nombre" placeholder="Nombre del termino" label-class="text-lightblue" fgroup-class="col-md-12">
                            ...
                            <div class="row">
                                <x-adminlte-select2 name="agrupado" label-class="text-lightblue"  fgroup-class="col-md-12"
                                    igroup-size="sm" data-placeholder="Es agrupado?..." >
                                    <x-slot name="prependSlot">
